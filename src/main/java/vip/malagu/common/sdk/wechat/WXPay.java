...
public class WXPay {
	...
	public Map<String, String> fillRequestDataForCustoms(Map<String, String> reqData) throws Exception {
		reqData.put("appid", config.getAppID());
		reqData.put("mch_id", config.getMchID());
		if (WXPayConstants.SignType.MD5.equals(this.signType)) {
			reqData.put("sign_type", WXPayConstants.MD5);
	...
	public Map<String, String> unifiedOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs)
		...
		Map<String, String> requestMsg = this.fillRequestData(reqData);
		String respXml = this.requestWithoutCert(url, requestMsg, connectTimeoutMs, readTimeoutMs);
		Map<String, String> result = this.processResponseXml(respXml);
		result.put("requestMsg", WXPayUtil.mapToXml(requestMsg));
		return result;
	}
	 ...
	 * @throws Exception
	 */
	public Map<String, String> custom(Map<String, String> reqData) throws Exception {
		return this.custom(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
	}
	 ...
	 * @throws Exception
	 */
	public Map<String, String> custom(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs)
			throws Exception {
		String url;
		if (this.useSandbox) {
			url = WXPayConstants.SANDBOX_ORDER_CUSTOM_URL_SUFFIX;
		} else {
			url = WXPayConstants.ORDER_CUSTOM_URL_SUFFIX;
		}
		String respXml = this.requestWithoutCert(url, this.fillRequestDataForCustoms(reqData), connectTimeoutMs,
				readTimeoutMs);
		return this.processResponseXml(respXml);
	}
	 ...
	 * @throws Exception
	 */
	public Map<String, String> customQuery(Map<String, String> reqData) throws Exception {
		return this.customQuery(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
	}
	 ...
	 * @throws Exception
	 */
	public Map<String, String> customQuery(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs)
			throws Exception {
		String url;
		if (this.useSandbox) {
			url = WXPayConstants.SANDBOX_ORDER_CUSTOM_QUERY_URL_SUFFIX;
		} else {
			url = WXPayConstants.ORDER_CUSTOM_QUERY_URL_SUFFIX;
		}
		String respXml = this.requestWithoutCert(url, this.fillRequestDataForCustoms(reqData), connectTimeoutMs,
				readTimeoutMs);
		return this.processResponseXml(respXml);
